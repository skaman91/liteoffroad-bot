...
•🟢 Зеленые. Точки «лайт». Когда вы устанавливаете эту точку, лебедку использовать нельзя. Лайт точки нужно устанавливать так, что бы их мог взять любой стоковый внедорожник, без риска повреждения лкп.
•🔴 Красные. Точки «хард». Эти точки стоят в сложных местах, где лебедка необходима.
•🔵 Синие. Точки «Ни то ни се», для установки которых может потребоваться лебедка.\n
•🟠 Оранжевые. Точки «Atv» Эти точки устанавливаются и берутся на мотоциклах и квадроциклах. Автомобилем точку брать можно, но перемещать нельзя.\n
...
Ставьте точки в пределах игровой зоны, обозначенной на нашей карте.
Штраф за нарушение — 2 балла.
Актуальные зоны нужно смотреть на карте. На карте есть зона отмеченная красной линией - это основная зона игры. На время этапа могут быть обозначены дополнительные зоны этапа, устанавливая точки в которых, вы получите баллы в рейтинге этапа. Если взять точку за пределами зоны этапа, то рейтинг этапа вам будет начислен, а за установку нет.\n
...
<!-- - <b>Красная зона</b> (стандартная зона игры) — баллы установки идут только в общий рейтинг.\n-->
...
5. <code>Добавить точку 20 Лайт Санкт-Петербург</code> - добавление точки, нужно выбрать номер и город\n
5. <code>Добавить точку 40 Хард Санкт-Петербург</code> - добавление Хард точки, нужно выбрать номер и город\n
5. <code>Добавить точку 50 Медиум Санкт-Петербург</code> - добавление Медиум точки, нужно выбрать номер и город\n
5. <code>Добавить точку 70 Atv Санкт-Петербург</code> - добавление Atv точки, нужно выбрать номер и город\n
...
const DAYS_FOR_INSTALL = 3 * 24 * 60 * 60 * 1000
