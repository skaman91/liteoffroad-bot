...
4. Для взятия и установки точки требуется АВТОМОБИЛЬ. Мотоцикл, снегоход, велосепед, гужевая повозка и тд не подходят.

5. Обязательно оформлять через бота ВЗЯТИЕ и УСТАНОВКУ точки. При переустановке точки, ФОТО УСТАНОВКИ с новыми координатами!
5.1 При переставновки точки новое место установке должно быть не ближе 1км от места взятия.
5.2 Нельзя брать точку повторно, если вы ее установили или брали, но оставляли на месте. Что бы повторно взять точку, ее сначала должен переставить другой участник.
