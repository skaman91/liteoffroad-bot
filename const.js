...
Условия взятия точки точно такие же, как в соревнованиях по GPS-ориентированию. Делаем фото взятия точки "рука-рука", но мы адекватные, поэтому можно и "рука-нога" :)
...
1. Устанавливайте точки в пределах города Санкт-Петербург или неподалеку от города не дальше 50 км. Выбирайте скрытные места, что бы точку не украли случайные прохожие.
...
Если за текущий день не появится игрок, который просто забыл ее оформить после взятия, то вам начислится рейтинг этой точки. Если украденная точка была установлена меньше 7 дней назад, то у установившего точку будет списан 1 балл.
